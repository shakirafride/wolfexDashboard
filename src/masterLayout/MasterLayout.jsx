                    ...
                    <div className='max-h-400-px overflow-y-auto scroll-sm pe-4'>
                      ...
                      >
                        <div className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                          <span className='w-44-px h-44-px bg-success-subtle text-success-main rounded-circle d-flex justify-content-center align-items-center flex-shrink-0'>
                            <img
                              src='https://images.pexels.com/photos/1040881/pexels-photo-1040881.jpeg?auto=compress&cs=tinysrgb&w=88&h=88&fit=crop'
                              alt='Ronald Richards'
                          ...
                          <div>
                            ...
                            <p className='mb-0 text-sm text-secondary-light text-w-200-px'>
                              New design system update available for review
                            </p>
                          </div>
                        </div>
                        <span className='text-sm text-secondary-light flex-shrink-0'>
                      ...
                      >
                        <div className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                          <span className='w-44-px h-44-px bg-info-subtle text-info-main rounded-circle d-flex justify-content-center align-items-center flex-shrink-0'>
                            <img
                              src='https://images.pexels.com/photos/1181519/pexels-photo-1181519.jpeg?auto=compress&cs=tinysrgb&w=88&h=88&fit=crop'
                              alt='Arlene McCoy'
                              style={{width: '44px', height: '44px', objectFit: 'cover', borderRadius: '50%'}}
                            />
                          </span>
                          <div>
                            ...
                            <p className='mb-0 text-sm text-secondary-light text-w-200-px'>
                              Invited you to collaborate on new project
                            </p>
                          </div>
                        </div>
                        <span className='text-sm text-secondary-light flex-shrink-0'>
                      ...
                      >
                        <div className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                          <span className='w-44-px h-44-px bg-success-subtle text-success-main rounded-circle d-flex justify-content-center align-items-center flex-shrink-0'>
                            <img
                              src='https://images.pexels.com/photos/1181424/pexels-photo-1181424.jpeg?auto=compress&cs=tinysrgb&w=88&h=88&fit=crop'
                              alt='Annette Black'
                              style={{width: '44px', height: '44px', objectFit: 'cover', borderRadius: '50%'}}
                            />
                          </span>
                          <div>
                            ...
                            <p className='mb-0 text-sm text-secondary-light text-w-200-px'>
                              Shared a new design mockup with you
                            </p>
                          </div>
                        </div>
                        <span className='text-sm text-secondary-light flex-shrink-0'>
                      ...
                      >
                        <div className='text-black hover-bg-transparent hover-text-primary d-flex align-items-center gap-3'>
                          <span className='w-44-px h-44-px bg-info-subtle text-info-main rounded-circle d-flex justify-content-center align-items-center flex-shrink-0'>
                            <img
                              src='https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=88&h=88&fit=crop'
                          ...
                          <div>
                            ...
                            <p className='mb-0 text-sm text-secondary-light text-w-200-px'>
                              Requested feedback on prototype design
                            </p>
                          </div>
                        </div>
                        <span className='text-sm text-secondary-light flex-shrink-0'>
