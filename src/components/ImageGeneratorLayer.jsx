                ...
                <div className="chat-main card overflow-hidden">
                    ...
                    <div className="chat-message-list max-h-612-px min-h-612-px">
                        ...
                        <div className="d-flex align-items-start justify-content-between gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                            <div className="d-flex align-items-center gap-16">
                                <div className="img overflow-hidden flex-shrink-0">
                                    <img
                                        src="https://ui-avatars.com/api/?name=Adam+Milner&size=44&background=6366F1&color=ffffff&rounded=true"
                                        alt="Adam Milner"
                        ...
                        <div className="d-flex align-items-start gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                            <div className="img overflow-hidden flex-shrink-0">
                                <img
                                    src="https://ui-avatars.com/api/?name=WowDash+AI&size=44&background=10B981&color=ffffff&rounded=true"
                                    alt="WowDash AI"
                                    className="w-44-px h-44-px rounded-circle object-fit-cover"
                                />
                            </div>
                            <div className="info flex-grow-1">
                                ...
                                <div className="row g-3">
                                    <div className="col-xl-3 col-sm-6">
                                        <div className="generated-image-item radius-8 overflow-hidden position-relative">
                                            <img
                                                ...
                                                alt="Professional man in business setting"
                                    ...
                                    <div className="col-xl-3 col-sm-6">
                                        <div className="generated-image-item radius-8 overflow-hidden position-relative">
                                            <img
                                                src="https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop"
                                    ...
                                    <div className="col-xl-3 col-sm-6">
                                        <div className="generated-image-item radius-8 overflow-hidden position-relative">
                                            <img
                                                src="https://images.pexels.com/photos/1043471/pexels-photo-1043471.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop"
                                    ...
                                    <div className="col-xl-3 col-sm-6">
                                        <div className="generated-image-item radius-8 overflow-hidden position-relative">
                                            <img
                                                src="https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop"
                        ...
                        <div className="d-flex align-items-start justify-content-between gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                            <div className="d-flex align-items-center gap-16">
                                <div className="img overflow-hidden flex-shrink-0">
                                    <img
                                        src="https://ui-avatars.com/api/?name=Adam+Milner&size=44&background=8B5CF6&color=ffffff&rounded=true"
                                        alt="Adam Milner"
                                        className="w-44-px h-44-px rounded-circle object-fit-cover"
                                    />
                                </div>
                        ...
                        <div className="d-flex align-items-start gap-16 border-bottom border-neutral-200 pb-16 mb-16">
                            <div className="img overflow-hidden flex-shrink-0">
                                <img
                                    src="https://ui-avatars.com/api/?name=WowDash+AI&size=44&background=F59E0B&color=ffffff&rounded=true"
                                    alt="WowDash AI"
                                    className="w-44-px h-44-px rounded-circle object-fit-cover"
                                />
                            </div>
                            <div className="info flex-grow-1">
                                ...
                                <div className="row g-3">
                                    <div className="col-sm-6">
                                        <div className="generated-image-item radius-8 overflow-hidden position-relative">
                                            <img
                                                src="https://images.pexels.com/photos/1040881/pexels-photo-1040881.jpeg?auto=compress&cs=tinysrgb&w=300&h=200&fit=crop"
