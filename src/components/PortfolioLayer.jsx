    ...
    return (
        <div className="card h-100 p-0 radius-12">
            <div className="card-body p-24">
                ...
                {/* Card Top End */}
                {/* Chart Start */}
                <ReactApexChart id="timeSeriesChart"
                    className="square-marker check-marker series-gap-24 d-flex justify-content-center" options={timeSeriesChartOptionsTwo} series={timeSeriesChartSeriesTwo} type="area"
                    height={350} />
                {/* Chart End */}
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    >
                                        <img
                                            src="https://picsum.photos/40/40?random=40"
                                            alt="Bitcoin"
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    >
                                        <img
                                            src="https://picsum.photos/40/40?random=41"
                                            alt="Ethereum"
                                            className="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden"
                                        />
                                        <span className="flex-grow-1 d-flex flex-column">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    >
                                        <img
                                            src="https://picsum.photos/40/40?random=43"
                                            alt="Binance"
                                            className="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden"
                                        />
                                        <span className="flex-grow-1 d-flex flex-column">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    >
                                        <img
                                            src="https://picsum.photos/40/40?random=44"
                                            alt="Dogecoin"
                                            className="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden"
                                        />
                                        <span className="flex-grow-1 d-flex flex-column">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    >
                                        <img
                                            src="https://picsum.photos/40/40?random=45"
                                            alt="Polygon"
                                            className="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden"
                                        />
                                        <span className="flex-grow-1 d-flex flex-column">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    >
                                        <img
                                            src="https://picsum.photos/40/40?random=46"
                                            alt="Cardano"
                                            className="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden"
                                        />
                                        <span className="flex-grow-1 d-flex flex-column">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    >
                                        <img
                                            src="https://picsum.photos/40/40?random=47"
                                            alt="Solana"
                                            className="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden"
                                        />
                                        <span className="flex-grow-1 d-flex flex-column">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    >
                                        <img
                                            src="https://picsum.photos/40/40?random=48"
                                            alt="Chainlink"
                                            className="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden"
                                        />
                                        <span className="flex-grow-1 d-flex flex-column">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    >
                                        <img
                                            src="https://picsum.photos/40/40?random=49"
                                            alt="Avalanche"
                                            className="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden"
                                        />
                                        <span className="flex-grow-1 d-flex flex-column">
