                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div className="d-flex align-items-center">
                                            <img
                                                src="https://images.pexels.com/photos/1040945/pexels-photo-1040945.jpeg?auto=compress&cs=tinysrgb&w=80&h=80&fit=crop"
                                                alt="Blue t-shirt"
                                ...
                                <tr>
                                    <td>
                                        <div className="d-flex align-items-center">
                                            <img
                                                src="https://images.pexels.com/photos/1536619/pexels-photo-1536619.jpeg?auto=compress&cs=tinysrgb&w=80&h=80&fit=crop"
                                                alt="Woman Dresses"
                                                className="flex-shrink-0 me-12 radius-8 me-12"
                                                style={{width: '40px', height: '40px', objectFit: 'cover'}}
                                            />
                                ...
                                <tr>
                                    <td>
                                        <div className="d-flex align-items-center">
                                            <img
                                                src="https://images.pexels.com/photos/437037/pexels-photo-437037.jpeg?auto=compress&cs=tinysrgb&w=80&h=80&fit=crop"
                                                alt="Smart Watch"
                                                className="flex-shrink-0 me-12 radius-8 me-12"
                                                style={{width: '40px', height: '40px', objectFit: 'cover'}}
                                            />
                                ...
                                <tr>
                                    <td>
                                        <div className="d-flex align-items-center">
                                            <img
                                                src="https://images.pexels.com/photos/1183266/pexels-photo-1183266.jpeg?auto=compress&cs=tinysrgb&w=80&h=80&fit=crop"
                                                alt="Hoodie Rose"
                                                className="flex-shrink-0 me-12 radius-8 me-12"
                                                style={{width: '40px', height: '40px', objectFit: 'cover'}}
                                            />
