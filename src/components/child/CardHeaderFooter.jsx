            ...
            <div className="row gy-4">
                <div className="col-xxl-4 col-sm-6">
                    <div className="card radius-12 h-100">
                        <div className="card-header py-16 px-24 bg-base d-flex align-items-center gap-1 justify-content-between border border-end-0 border-start-0 border-top-0">
                            <h6 className="text-lg mb-0">Welcome to Freepik</h6>
                        ...
                        <div className="card-body py-16 px-24">
                            ...
                            <p className="card-text text-neutral-600 mb-0">
                                Access millions of high-quality vectors, photos, and PSD files from Freepik. 
                                Transform your creative projects with professional design assets that inspire 
                    ...
                    <div className="card radius-12 h-100">
                        <div className="card-body py-16 px-24">
                            <div className="d-flex align-items-center gap-2 mb-12">
                                ...
                                <h6 className="text-lg mb-0">Creative Community Hub</h6>
                            </div>
                            <p className="card-text text-neutral-600 mb-16">
                                Join Freepik's vibrant community of designers, creators, and innovators. 
                                Share your work, get inspired, and collaborate on amazing projects 
                                with like-minded professionals.
                            </p>
                            <p className="card-text text-neutral-600 mb-0">
                                Connect with millions of creators worldwide and showcase your talent 
                                on the world's leading design platform.
                            </p>
                            <Link
                                to="#"
                ...
                <div className="col-xxl-4 col-sm-6">
                    <div className="card radius-12 h-100">
                        <div className="card-header py-16 px-24 bg-base d-flex align-items-center gap-1 justify-content-between border border-end-0 border-start-0 border-top-0">
                            <div>
                                <h6 className="text-lg mb-0">Freepik Support Center</h6>
                        ...
                        <div className="card-body py-16 px-24">
                            <p className="card-text text-neutral-600 mb-16">
                                Get instant support from Freepik's expert team. Whether you need help 
                                with downloads, licensing, or creative guidance, our support specialists 
                                are here to assist you.
                            </p>
                            <p className="card-text text-neutral-600 mb-0">
                                Access comprehensive tutorials, FAQs, and personalized assistance 
                                to make the most of your Freepik experience.
                            </p>
                        </div>
                    </div>
                </div>
