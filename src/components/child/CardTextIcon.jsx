                ...
                <div className="col-xxl-3 col-sm-6">
                    <div className="card h-100 radius-12">
                        <div className="card-body p-24">
                            ...
                            <h6 className="mb-8">Creative Branding</h6>
                            <p className="card-text mb-8 text-secondary-light">
                                Professional brand identity design services from Freepik's creative team. 
                                Build memorable brands that connect with your audience.
                            </p>
                            <Link
                                to="#"
                ...
                <div className="col-xxl-3 col-sm-6">
                    <div className="card h-100 radius-12 text-center">
                        <div className="card-body p-24">
                            ...
                            <h6 className="mb-8">Digital Design</h6>
                            <p className="card-text mb-8 text-secondary-light">
                                Modern UI/UX design solutions powered by Freepik's extensive 
                                design resources and professional templates.
                            </p>
                            <Link
                                to="#"
                ...
                <div className="col-xxl-3 col-sm-6">
                    <div className="card h-100 radius-12 text-end">
                        <div className="card-body p-24">
                            ...
                            <h6 className="mb-8">Growth Strategy</h6>
                            <p className="card-text mb-8 text-secondary-light">
                                Strategic business growth solutions with premium Freepik 
                                marketing materials and professional consultation services.
                            </p>
                            <Link
                                to="#"
                ...
                <div className="col-xxl-3 col-sm-6">
                    <div className="card h-100 radius-12 text-center">
                        <div className="card-body p-24">
                            ...
                            <h6 className="mb-8">Web Development</h6>
                            <p className="card-text mb-8 text-secondary-light">
                                Professional web development services using Freepik's 
                                cutting-edge design assets and modern coding practices.
                            </p>
                            <Link
                                to="#"
