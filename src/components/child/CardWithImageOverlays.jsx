            ...
            <div className="row gy-4">
                <div className="col-xxl-4 col-sm-6">
                    <div className="card h-100 radius-12 p-0 overflow-hidden position-relative">
                        <div className="card-body p-0 gradient-overlay bottom-0 start-0">
                            <img
                                src="https://img.freepik.com/free-photo/modern-office-workspace-with-laptop-coffee_23-2149429285.jpg"
                 ...
                 text-lg mb-6"
                                ...
                                <p className="card-text text-white">
                                    Discover premium workspace designs from Freepik's collection. 
                                    Create inspiring environments that boost productivity and creativity 
                ...
                <div className="col-xxl-4 col-sm-6">
                    <div className="card h-100 radius-12 p-0 overflow-hidden position-relative">
                        <div className="card-body p-0 gradient-overlay top-0 start-0">
                            <img
                                src="https://img.freepik.com/free-photo/creative-team-meeting-brainstorming-session_23-2149429156.jpg"
                 ...
                 text-lg mb-6"
                                ...
                                <p className="card-text text-white">
                                    Explore Freepik's collaborative design solutions that bring teams 
                                    together. Foster innovation and creativity with professional 
                ...
                <div className="col-xxl-4 col-sm-6">
                    <div className="card h-100 radius-12 p-0 overflow-hidden position-relative">
                        <div className="card-body p-0 gradient-overlay bottom-0 start-0">
                            <img
                                src="https://img.freepik.com/free-photo/digital-marketing-strategy-planning_23-2149429201.jpg"
                 ...
                 text-lg mb-6"
                                ...
                                <p className="card-text text-white">
                                    Leverage Freepik's comprehensive marketing assets to create 
                                    compelling campaigns. Drive engagement with professional 
                                    graphics and strategic design elements.
                                </p>
                                <Link
                                    to="#"
                                    className="btn text-primary-600 hover-text-primary px-0 py-10 d-inline-flex align-items-center gap-2"
